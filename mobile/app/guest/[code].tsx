...
export default function GuestDetailScreen() {
    ...
    if (!guest) return <View style={styles.loadingContainer}><ActivityIndicator color={Colors.light.gold} size="large" /><Text style={styles.loadingText}>Unveiling your experience...</Text></View>;
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Floating Header (Shown on scroll) */}
...
const styles = StyleSheet.create({
    ...
    logoutButton: { position: 'absolute', top: 60, left: 30, zIndex: 10 },
