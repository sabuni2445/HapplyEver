...
import { PlusCircle, User, Settings, LogOut, Briefcase, Calendar } from "lucide-react";
...
export default function VendorSidebar() {
  ...
  const menuItems = [
    { path: "/vendor/dashboard", icon: Briefcase, label: "My Services" },
    { path: "/vendor/add-service", icon: PlusCircle, label: "Add Service" },
